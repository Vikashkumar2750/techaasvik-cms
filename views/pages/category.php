...
<div class="container" style="padding-top:var(--space-10);padding-bottom:var(--space-16);">
  ...
  <?php \Core\View::partial('breadcrumb', ['crumbs' => [['name'=>'Home','url'=>'/'],['name'=>$cat['name']]]]) ?>

  <div style="margin-top:var(--space-4);margin-bottom:var(--space-10);">
    <h1><?= e($cat['name']) ?></h1>
    <?php if (!empty($cat['description'])): ?>
    <p style="font-size:var(--text-lg);color:var(--text-secondary);max-width:640px;margin-top:var(--space-3);"><?= e($cat['description']) ?></p>
    <?php endif; ?>
    <p style="color:var(--text-muted);font-size:var(--text-sm);margin-top:var(--space-2);"><?= number_format($total) ?> articles published</p>
  </div>
  ...
  <?php \Core\View::partial('pagination', ['total' => $total, 'page' => $page, 'perPage' => $perPage, 'baseUrl' => '/category/' . $cat['slug']]) ?>
